...
# AGENTS.md — Governed Swarm Assignment: aresmax-blog
...
repo: aresmax-blog
type: static-site
canonical_purpose: Static HTML blog â€” articles, store pages for Aresmax brand
authority_ceiling: 1
```
...
iteration:
  ...
  branch_pattern: "agency/aresmax-blog/{gap_id}"
  pr_title_pattern: "swarm(aresmax-blog): {gap_id} — {description}"
